    ...
    <section className="main">
      <div className="main__info">
        ...
        <div className="main__description text">
          ...
          развитии или речи учатся решать математичексие задачи по следующим
          темам: сложение, вычитание, порядковый счет, состав числа. Ниже вы
          можете ознакомиться с разделами сайта
        </div>
      </div>
      <div className="steps">
