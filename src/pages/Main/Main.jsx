		...
		<section className='main'>
			<div className='main__info'>
				<h1 className='main__title title'>
					...
					безошибочного обучения для детей с задержками в развитии или речи
				</h1>
				<div className='main__description text'>
					Добро пожаловать на сайт, с помощью которого дети с задержками в
					развитии или речи учатся решать математичексие задачи по
					следующим темам: сложение, вычитание, порядковый счет, состав
					числа. Ниже вы можете ознакомиться с разделами сайта
				</div>
			</div>
			<div className='steps'>
				<div className='step step-one'>
					...
					<div className='step__text text'>
						В данной вкладке вы сможете ознакомиться с инструкцией по
						тому, как правильно использовать тренажер в обучающих целях
					</div>
				</div>
				<div className='step step-two'>
					...
					<div className='step__text text'>
						...
						безошибочного обучения, его цель и как он реализован в
						тренажере
					</div>
				</div>
