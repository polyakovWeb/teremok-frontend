    ...
    <div className="instruction-wrapper">
      ...
      <ul className="step-list">
        <li className="instruction-step">
          <span>
            Создать свою учётную запись (родителя/учителя) на данной платформе
          </span>
        </li>
        <li className="instruction-step">
          <span>
      ...
      <p className="info">
        Перед началом выполнения заданий в самом тренажёре, необходимо провести
        его простую настройку. Для этого вам будут представлены соответствующий
        окошки с возможностью выбора. Примеры проиллюстрированы ниже:
      </p>
      ...
      <p className="info">
        ...
        выполненое задание он будет награждаться одной из них. А после
        выполнения всех заданий - сможет посмотреть собранные им карточки и
        мультик.
      </p>
      <p className="info">
      ...
      <p className="info">
        Если ребёнок решил задание верно не с первой попытки, то запускается
        процесс отвлечения в виде таймера, где ему необходимо похлопать в
        ладоши. После окончания таймера ребёнок должен решить верно этот же
        пример, но с первого раза. Иначе его ждёт повторение описанных выше
        действий до тех пор, пока задание будет выполнено без допущения ошибок.
      </p>
      <p className="info">
